...
**Examples:**
```
# Standard Overwrite (Fastest, best for big repos - Uses clear mirror naming structure)
client1|git@github.com:my-org/site.git|main|web/example.com/private/PROJECT-GITHUB-MIRROR|overwrite

# Versioned (Keeps last 5 zip-like folders)
client1|git@github.com:my-org/site.git|main|web/example.com/private/PROJECT-GITHUB-MIRROR|versioned|5

# Smart Backup (Uses global Daily/Weekly/Monthly settings)
client1|git@github.com:my-org/site.git|main|web/example.com/private/PROJECT-GITHUB-MIRROR|backup
```
